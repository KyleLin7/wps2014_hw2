...
$('.story').hover(function() {
  $('p.story').css('display', 'block');
});

$('.online').hover(function() {
  $('p.online').css('display', 'block');
});

$('.option').hover(function() {
  $('p.option').css('display', 'block');
});

$('.extras').hover(function() {
  $('p.extras').css('display', 'block');
});

$('.ingame').hover(function() {
  $('p.ingame').css('display', 'block');
});

$('.exit').hover(function() {
  $('p.exit').css('display', 'block');
});

// Enlève les attributs à la sortie de ul li
